...
public class PlayerPropBananaPeelJumpingState : PlayerBaseState
{
    ...
    public PlayerPropBananaPeelJumpingState(PlayerStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        {
            _stateMachine.SwitchState(new PlayerPropBananaPeelFallingState(_stateMachine));
            return;
        }
